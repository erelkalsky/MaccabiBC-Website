<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="Erel2.Pages.SignUp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="sing-up-form">
        ...
        <input class="input-box" type="text" id="firstName" name="firstname" oninput="valFirstName()" placeholder="שם פרטי" />
        <%--<h1 id="firstNameAlert" class="msgError"></h1>--%>

        <input class="input-box" type="text" id="lastName" name="lastname" oninput="valLastName()" placeholder="שם משפחה" />
        <%--<h1 id="lastNameAlert" class="msgError"></h1>--%>

        <input class="input-box" type="text" id="userName" name="username" oninput="valUserName()" placeholder="שם משתמש" />
        <%--<h1 id="userNameAlert" class="msgError" runat="server"></h1>--%>

        <input class="input-box" type="password" id="password" name="password" oninput="valPassword()" placeholder="סיסמא" />
        ...
        <select class="select-box-small" id="phoneAreaCode" name="phoneAreaCode" onchange="valPhone()">
            <option disabled="disabled" selected="selected">קידומת</option>
            <option>02</option>
            <option>03</option>
            <option>04</option>
            <option>050</option>
        ...
        <input class="phone-box" type="text" id="phone" name="phone" oninput="valPhone()" placeholder="טלפון" />
        <%--<h1 id="phoneAlert" class="msgError"></h1>--%>

        <select class="select-box-big" id="gender" name="gender">
            <option disabled="disabled" selected="selected">מגדר</option>
            <option id="Male" name="Male" value="Male">זכר</option>
            <option id="Female" name="Female" value="Female">נקבה</option>
        </select>
        <%--<h1 id="genderAlert" class="msgError"></h1>--%>

        <button class="button" type="submit" onclick="return Validate()" >הרשמה</button>
        <button class="button" type="reset" onclick="return resetForm()">ניקוי</button>
    </div>
